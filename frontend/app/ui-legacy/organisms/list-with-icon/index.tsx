...
import { CardWithIcon } from '../../molecules/card-with-icon';

interface IComputationRequestsList {
  items?: Computation[];
  isLoading?: boolean;
  linkPrefix: string;
}
...
export const ListWithIcon = ({ items, isLoading, linkPrefix }: IComputationRequestsList) => {
