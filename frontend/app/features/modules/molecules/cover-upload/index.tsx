...
export const UploadCover = ({
  ...
  return (
    <>
      <div className="flex">
        <div
          className="shadow-shadow4 text-primaryBlue910 flex items-center justify-center mr-2 bg-white overflow-hidden"
          style={{ width: 291, height: 138, borderRadius: '20px 20px 20px 0px' }}
        >
          {!image ? (
