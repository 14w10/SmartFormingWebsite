...
class Matcardhr():
    ...
    def run(self, blank_material_name, blank_material_thickness, blank_material_supplier, temperature_min,
        ...
        SR_range = np.array([0.1, 1, 3]) / 1000
        ...
        temperature = np.arange(temperature_min, temperature_max, 50)
        if temperature_max != temperature[-1]:
            temperature = np.append(temperature, temperature_max)
        ...
        for i in range(0, len(temperature)):
            R = 8.314
            if blank_material_name == 'AA6111' and blank_material_thickness == 2:
                threshold = 350  # last temperature on low temp
            ...
            elif blank_material_name == 'AA7075' and blank_material_thickness == 2:
                threshold = 350  # last temperature on low temp
                if temperature[i] <= threshold:
                    Capital_K0 = 1.644111308
                    QCapital_K = 21676.635
                    k0 = 0.000042162
                    Qk = 47143.461
                    B0 = 0.515663942
                    QB = 22751.118
                    ...
                    Qn = -3009.1341
                    n2 = 5
                    Aa0 = 8.26293105220129
                    QAa = -0.0134572126807515
                    Bb0 = -0.126037089345685
                    QBb = 0.000212361292544567
                    Cc0 = -22.5296904974540
                    QCc = 0.0344177008876700
                else:
                    Capital_K0 = 0.96802245
                    QCapital_K = 25656.294
                    k0 = 0.0000139784
                    Qk = 24392.343
                    B0 = 231.3657982
                    QB = -13963.293
        ...
        # fig.write_html('material_card_figure.html')
